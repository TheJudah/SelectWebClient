...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void LoadVenuesDropDown()
    {
        ...
        VenuesDropDown.Items.Insert(0, "Select Venue");
        VenuesDropDown.Items.Insert(1, "nope, not that, kidding");
    }
    protected void LoadArtistsDropDown()
    {
        ...
        ArtistsDropDown.Items.Insert(0, "Select Artist");
        ArtistsDropDown.Items.Insert(1, "nope, not that, kidding");
    }
